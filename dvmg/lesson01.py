...
def set_color(color='\u001b[0m'):
    print (color)

def clean(lines=25):
    print('\033[2J')
    print (f'\u001b[{lines+1}A',end='')
    print ('\r', end='')
    pass
